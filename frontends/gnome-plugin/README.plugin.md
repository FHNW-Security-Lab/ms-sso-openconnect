...
Default: enabled. If the tunnel drops, times out, or initial connect fails, it
automatically retries for a bounded number of attempts.
...
# Max watchdog retries (0 = unlimited)
nmcli connection modify FHNW +vpn.data reconnect-max-attempts=5
```
...
MS_SSO_NM_RECONNECT_MAX_ATTEMPTS=5
MS_SSO_NM_GP_RECONNECT_MAX_ATTEMPTS=5
